...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('real_content_scraper.log'),
    ...
    def __init__(self):
        ...
        self.scraping_sources = {
            'tsukuba_city': {
                ...
                'name': 'つくば市',
                'event_url': 'https://www.city.tsukuba.lg.jp/soshiki/1/event.html',
            ...
            'tsukubamirai_city': {
                ...
                'name': 'つくばみらい市',
                'event_url': 'https://www.city.tsukubamirai.lg.jp/soshiki/1/event.html',
                'culture_url': 'https://www.city.tsukubamirai.lg.jp/kankobunka/',
                'childcare_url': 'https://www.city.tsukubamirai.lg.jp/kosodate/',
                'tourism_url': 'https://www.city.tsukubamirai.lg.jp/kankobunka/'
            },
            'moriya_city': {
                'base_url': 'https://www.city.moriya.ibaraki.jp/',
                'name': '守谷市',
                'event_url': 'https://www.city.moriya.ibaraki.jp/soshiki/1/event.html',
                'culture_url': 'https://www.city.moriya.ibaraki.jp/kankobunka/',
                'childcare_url': 'https://www.city.moriya.ibaraki.jp/kosodate/',
                'tourism_url': 'https://www.city.moriya.ibaraki.jp/kankobunka/'
            },
            'toride_city': {
                'base_url': 'https://www.city.toride.ibaraki.jp/',
                'name': '取手市',
                'event_url': 'https://www.city.toride.ibaraki.jp/soshiki/1/event.html',
                'culture_url': 'https://www.city.toride.ibaraki.jp/kankobunka/',
                'childcare_url': 'https://www.city.toride.ibaraki.jp/kosodate/',
                'tourism_url': 'https://www.city.toride.ibaraki.jp/kankobunka/'
            }
        }
    ...
    def extract_seasonal_events(self, city_id, source):
        ...
        try:
            ...
            for link in event_links:
                ...
                seasonal_keywords = ['桜', '花火', '祭り', 'フェスティバル', 'マルシェ', '収穫祭', 'イルミネーション']
                
                if any(keyword in title for keyword in seasonal_keywords):
                    # 詳細ページを取得
    ...
    def extract_food_info(self, city_id, source):
        ...
        try:
            ...
            if content:
                ...
                food_keywords = ['飲食', 'グルメ', 'カフェ', 'レストラン', '居酒屋', 'ラーメン', '新規オープン']
    ...
    def extract_childcare_info(self, city_id, source):
        ...
        try:
            ...
            for link in childcare_links:
                ...
                childcare_keywords = ['子育て', '育児', '保育', '児童館', '子育て支援', '親子']
                
                if any(keyword in title for keyword in childcare_keywords):
                    detail_url = urljoin(source['base_url'], href)
                    detail_content = self.get_page_content(detail_url)
    ...
    def extract_tourism_info(self, city_id, source):
        ...
        try:
            ...
            for link in tourism_links:
                ...
                tourism_keywords = ['観光', '観光地', '観光スポット', '名所', '史跡', '公園']
                
                if any(keyword in title for keyword in tourism_keywords):
                    detail_url = urljoin(source['base_url'], href)
                    detail_content = self.get_page_content(detail_url)
    ...
    def extract_culture_info(self, city_id, source):
        ...
        try:
            ...
            for link in culture_links:
                ...
                culture_keywords = ['博物館', '美術館', '図書館', '文化センター', '展示', '企画展']
